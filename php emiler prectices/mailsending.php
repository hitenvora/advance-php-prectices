...
try {
    ...
    //Recipients
    $mail->setFrom($_POST["txtEmail"],'mail sending');
    ...
    $mail->Body    =  "<p> costmer name is</p>" .$nm."<br>". "<p> costmer email is</p>" .$em."<br>". "<p> costmer phone is</p>" .$pn."<br>". "<p> costmer message is</p>" .$ms."<br>";
